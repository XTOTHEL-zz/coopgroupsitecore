...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupInsuranceHome.aspx.cs" Inherits="GroupInsuranceUI.layouts.GroupInsurance.Layouts.GroupInsuranceHome" %>
...
<head runat="server" id="head">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('mouseup mousedown keypress click', function (e) {
                var container = $("#gen");
